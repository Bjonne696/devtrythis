    ...
    <>
      ...
      <PageContainer>
        <ContentSection>
          ...
          <TextBlock>Vi samler inn følgende informasjon:</TextBlock>
          <List>
            <ListItem>
              Navn og kontaktinformasjon når du registrerer deg
            </ListItem>
          ...
          <List>
            ...
            <ListItem>
              For å oppfylle juridiske forpliktelser (inkludert regnskapslov)
            </ListItem>
          </List>

          <Subtitle>Informasjonskapsler (Cookies)</Subtitle>
          <TextBlock>Vi bruker informasjonskapsler for:</TextBlock>
          <List>
          ...
          <List>
            <ListItem>
              Betalinger behandles av Vipps MobilePay, en tredjeparts
              betalingsleverandør
            </ListItem>
            <ListItem>
              Vi lagrer IKKE kortinformasjon eller sensitive betalingsdetaljer
            </ListItem>
            <ListItem>
              Vi lagrer kun abonnementsstatus, betalingshistorikk (dato, beløp),
              og leverandør-ID
            </ListItem>
            <ListItem>
              Betalingsdata brukes kun for å administrere abonnementet ditt og
              oppfylle juridiske krav
            </ListItem>
            <ListItem>
              Vipps MobilePay har sitt eget personvernreglement som regulerer
              behandling av betalingsdata
            </ListItem>
          </List>
          <TextBlock>
            <strong>Datalagring:</strong> Abonnementsdata lagres så lenge
            abonnementet er aktivt og i 5 år etter kansellering for
            regnskapsmessige formål. Du kan når som helst be om en kopi av dine
            betalingsdata eller sletting etter lovpålagt lagringsperiode.
          </TextBlock>

          <Subtitle>Dine rettigheter</Subtitle>
          <TextBlock>I henhold til GDPR har du rett til:</TextBlock>
          <List>
          ...
          <ContactInfo>
            ...
            <strong>Anitaberge@yahoo.no</strong>
          </ContactInfo>
